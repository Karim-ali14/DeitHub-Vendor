...
public class SplashActivity extends AppCompatActivity {
                ...
                try {
                    if (!pref.getLagu().equals("empty")) {
                        if (pref.getLagu().equals("ar")) {
                            ...
                            Common.setAppLocale(languageToLoad,SplashActivity.this);
                            pref.setLangu("ar");
    ...
    private void autoLogin() {
        if (preferences.contains(Common.Token)&&preferences.contains(Common.ProviderId)){
            if (Common.checkToken(preferences.getString(Common.Token,""))){
                Log.i("TTTTTTT", "Token is not EX "+
                        Common.checkToken(preferences.getString(Common.Token,"")));
